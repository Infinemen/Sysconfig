...
update() {
    ...
    if   [ "$bat_text" -ge 95 ]; then bat_icon="󱊣 "; charge_icon="";
    elif [ "$bat_text" -ge 70 ]; then bat_icon="󱊢 ";
    elif [ "$bat_text" -ge 40 ]; then bat_icon="󱊡 ";
    elif [ "$bat_text" -ge 10 ]; then bat_icon="󰂎 ";
    else bat_icon="󱈐 "; fi
