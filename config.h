...
static Key keys[] = {
	...
	{ Mod4Mask,            XK_space,        selectlayout,     {.v = &layouts[1]} },      /* super space      |  切换到网格布局 */
	{ MODKEY,              XK_o,            showonlyorall,    {0} },                     /* ALT o            |  切换 只显示一个窗口 / 全部显示 */

    { MODKEY|ControlMask,  XK_equal,        setgap,           {.i = -6} },               /* ALT ctrl +       |  窗口增大 */
    { MODKEY|ControlMask,  XK_minus,        setgap,           {.i = +6} },               /* ALT ctrl -       |  窗口减小 */
    { MODKEY|ControlMask,  XK_space,        setgap,           {.i = 0} },                /* ALT ctrl space   |  窗口重置 */

    { MODKEY|ControlMask,  XK_Up,           movewin,          {.ui = UP} },              /* ALT ctrl up      |  移动窗口 */
    { MODKEY|ControlMask,  XK_Down,         movewin,          {.ui = DOWN} },            /* ALT ctrl down    |  移动窗口 */
    { MODKEY|ControlMask,  XK_Left,         movewin,          {.ui = LEFT} },            /* ALT ctrl left    |  移动窗口 */
    { MODKEY|ControlMask,  XK_Right,        movewin,          {.ui = RIGHT} },           /* ALT ctrl right   |  移动窗口 */

    { MODKEY|Mod4Mask,     XK_Up,           resizewin,        {.ui = V_REDUCE} },        /* ALT super up       |  调整窗口 */
    { MODKEY|Mod4Mask,     XK_Down,         resizewin,        {.ui = V_EXPAND} },        /* ALT super down     |  调整窗口 */
    { MODKEY|Mod4Mask,     XK_Left,         resizewin,        {.ui = H_REDUCE} },        /* ALT super left     |  调整窗口 */
    { MODKEY|Mod4Mask,     XK_Right,        resizewin,        {.ui = H_EXPAND} },        /* ALT super right    |  调整窗口 */
